...
from MuchPool.modules import GCNBlock, CasualPickBlock
from MuchPool.modules import AttPoolBlock
from MuchPool.modules import DegreePickBlock
from MuchPool.modules import SoftPoolingGcnEncoder
...
class MuchPool(nn.Module):
    def __init__(self, args):
        ...
        self.AttPool = CasualPickBlock(args)
    ...
    def forward(self, X, adj, mask):
        ...
        '''
        # result of DiffPool model 全局池化部分
        ...
        if self.args.local_topology and self.args.with_feature and self.args.global_topology:
            ...
            feature_based_index, H2, k_list2 = self.AttPool.forward(X, adj, mask, assign_matrix, H_coarse)
